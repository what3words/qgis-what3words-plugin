...
class Ui_discoverToWhat3words(object):
    def setupUi(self, discoverToWhat3words):
        ...
        self.table_management = QtWidgets.QGroupBox(self.dockWidgetContents)
        font = QtGui.QFont()
        font.setFamily("Microsoft Sans Serif")
        font.setPointSize(11)
        self.table_management.setFont(font)
        self.table_management.setAlignment(QtCore.Qt.AlignCenter)
        self.table_management.setObjectName("table_management")
        self.table_management_2 = QtWidgets.QHBoxLayout(self.table_management)
        self.table_management_2.setContentsMargins(2, 2, 2, 2)
        self.table_management_2.setObjectName("table_management_2")
        self.saveToFileButton = QtWidgets.QToolButton(self.table_management)
        ...
        self.table_management_2.addWidget(self.saveToFileButton)
        self.createLayerButton = QtWidgets.QToolButton(self.table_management)
        self.createLayerButton.setMinimumSize(QtCore.QSize(30, 30))
        self.createLayerButton.setObjectName("createLayerButton")
        self.table_management_2.addWidget(self.createLayerButton)
        self.deleteSelectedButton = QtWidgets.QToolButton(self.table_management)
        self.deleteSelectedButton.setMinimumSize(QtCore.QSize(30, 30))
        self.deleteSelectedButton.setObjectName("deleteSelectedButton")
        self.table_management_2.addWidget(self.deleteSelectedButton)
        self.clearAll = QtWidgets.QToolButton(self.table_management)
        self.clearAll.setMinimumSize(QtCore.QSize(30, 30))
        self.clearAll.setObjectName("clearAll")
        self.table_management_2.addWidget(self.clearAll)
        self.topButtons.addWidget(self.table_management)
    ...
    def retranslateUi(self, discoverToWhat3words):
        ...
        self.table_management.setToolTip(_translate("discoverToWhat3words", "Table Management"))
        self.table_management.setTitle(_translate("discoverToWhat3words", "Table Management"))
